        ...
        <div className="practice-layout">
          ...
          <section className="practice-main">
            <div className="practice-toolbar">
              <h2>풀 수 있는 시험</h2>
              <button type="button" className="soft-action" onClick={onRefresh}>
                <RefreshCw size={16} />
                새로고침
              </button>
            </div>
...
function PracticeExamCard({
  ...
  return (
    <article className="practice-exam-card">
      ...
      <button type="button" className="dark-action" onClick={() => onStart(exam)}>
        <PlayCircle size={16} />
    ...
    <section className="exam-take-view">
      <div className="exam-take-inner">
        <header className="exam-take-header">
          <button type="button" className="soft-action" onClick={onBackToList}>
            <ArrowLeft size={16} />
            시험 목록
          </button>
          <div>
          ...
          <button type="button" className="dark-action" disabled={submitting} onClick={onSubmit}>
